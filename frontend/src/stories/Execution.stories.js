...
import { TableExecutionList, ExecutionUI, NewExecutionList } from '../components'
...
export const newExecutionList = () => <NewExecutionList onSelect={action('onSelect')} executions={executions} />
